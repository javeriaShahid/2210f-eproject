...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="row">
                <div class="col-md-6">  <h5 class="card-header">About us Management</h5></div>
                <div class="col-md-6">
                    <div class="row justify-content-end mt-3">
                        <div class="col-md-3"><a class="btn btn-success" href="{{ route('admin.aboutussettings.create') }}"><i class="bx bx-plus"></i></a></div>
                    </div>
                </div>
            </div>
            <div class="table-responsive text-nowrap">
              <table class="table table-hover">
                <thead>
                  <tr>
                    <th>S.no</th>
                    <th>Image of About us</th>
                    <th>Title of About us</th>
                    <th>Side of Image</th>
                ...
                <tbody class="table-border-bottom-0" >
                    @foreach ($data['about'] as $aboutus )
                        <tr>
                            ...
                            <td><img src="{{asset('aboutusImages/'. $aboutus->image )}}" alt="{{$aboutus->image}}" style="width: 50px; height:50px; object-fit:cover;"></td>
                            <td>{{ $aboutus->title }}</td>
                            <td>{{ $aboutus->side }}</td>
                            <td>@if($aboutus->categories != null)
                                {{ $aboutus->categories->name }}
                                @endif
                            </td>
                            ...
                            {{-- Modal button ends --}}
                            <td><a href="{{ route('admin.aboutussettings.edit' , $aboutus->id) }}" class="btn btn-success"><i class="bx bx-pencil"></i></a> | <a href="{{ route('admin.aboutussettings.delete' , $aboutus->id) }}" class="btn btn-danger"><i class="bx bx-trash"></i></a></td>
...
<script>
   ...
   let changeStatusUrl = "{{route('admin.aboutussettings.change_status')}}" ;
