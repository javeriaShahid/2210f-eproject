      ...
      <div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <input value="{{$data['comment']->subject}}" disabled name="image" type="text" class="form-control" placeholder="Second title" aria-describedby="defaultFormControlHelp"/>
            </div>
            <div class="col-md-12 mt-2">
                <label for="defaultFormControlInput" class="form-label mb-3"><div class="bx bx-message"></div> Message </label>
                <textarea  disabled name="" class="form-control" id="" cols="30" rows="10">{{$data['comment']->message}}</textarea>
            </div>

            <div class="col-md-12">
                <a href="{{route('admin.blogs.comments')}}" id="submitButton" class="btn-primary btn mt-3">Back</a>
            </div>
        </div>
        </div>
      </div>
