            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="row justify-content-end mt-3">
                        <div class="col-md-3"><a class="btn btn-success" href="{{ route('product.index') }}"><i class="bx bx-home"></i></a></div>
                    </div>
                </div>
            </div>
                ...
                <tbody class="table-border-bottom-0" >
                    @foreach ($data['product'] as $product )
                        <tr>
                            ...
                            <td><img src="{{ asset("ProductImages/" . $product->image) }}" style="width:40px; height:40px; object-fit:cover;" alt=""></td>
                            ...
                            <td><button class="btn" style="background-color:{{$product->color_code}}!important"></button></td>
                             <td>{{ $product->sku }}</td>
                            {{-- Modal button ends --}}
                            <td><a href="{{ route('product.restore' , $product->id) }}" class="btn btn-success"><i class="bx bx-undo"></i></a></td>
                            <td><a href="{{ route('product.destroy' , $product->id) }}" class="btn btn-danger"><i class="bx bx-trash"></i></a></td>
                        </tr>
