...
<body>
                ...
                <div class="container" style="border: 1px solid rgb(158, 158, 158); width:600px; margin:auto; border-radius:5px ; height:400px; position:relative; top:60px; padding:10px;">
                    ...
                    <div class="subject">
                        <h5 style="font-size: 30px; color:rgb(68, 67, 67); text-align:center ; position:relative; bottom:30px;">Contact request</h5>
                    </div>
                    <div class="paragraph">
                        <p style="color:orangered; font-size:15px; font-family:arial; text-align:center ; position:relative ; bottom:30px;">Thank you for choosing Dazzle! We're on it and will get back to you in a blink. Your support means the world. Happy Shopping, and may your day sparkle with joy!</p>
                    </div>
