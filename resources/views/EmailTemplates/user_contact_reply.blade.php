...
<body>
                ...
                <div class="container" style="border: 1px solid rgb(158, 158, 158); width:600px; margin:auto; border-radius:5px ; height:400px; position:relative; top:60px; padding:10px;">
                    ...
                    <div class="subject">
                        <h5 style="font-size: 25px; color:rgb(68, 67, 67); text-align:center ; position:relative; bottom:30px;">Replied message From Dazzle For Contact</h5>
                    </div>
                    <div class="paragraph">
                        <p style="color:orangered; font-size:15px; font-family:arial; text-align:center ; position:relative ; bottom:30px;">{{$messageData}}</p>
                    </div>
