...
@php
$cartdata = \App\Models\Cart::where(["user_id" => session()->get('user')['id']])->count();
@endphp
@if($cartdata > 0)
<div class="checkout-section pt-110 mb-110">
                    ...
                    <form action="" id="createAddressForm">
                        @csrf
                            ...
                            <div class="form-inner">
                               ...
                               <input type="text" name="postalcode" id="address_postal" placeholder="Postal / Zip Code">
                            </div>
    ...
    <input type="text" id="EmailAddress" name="email" placeholder="Your Email address"  value="{{ session()->get('user')['email'] }}">
    </div>
    </div>
    <div class="col-12">
    <div class="form-inner">
    ...
    <input type="text" name="postalcode" id="mainPostal" placeholder="Post Code / Zip Code">
    </div>
    </div>
    <div class="col-12">
    <div class="form-inner">
    ...
    <div class="container mt-5 mb-5">
        <img src="{{asset('assets/img/Emptycart.png')}}" alt="">
        <center>
            <a class="primary-btn1 hover-btn3" href="{{route('user.index')}}">Add Products To Cart</a>
        </center>
    </div>
    {{-- End if --}}
    @endif
